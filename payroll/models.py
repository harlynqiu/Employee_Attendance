...
class Payroll(models.Model):
    ...
    def compute_delivery_allowance(
        self,
        attendance_records
    ):
    ...
    def save(self, *args, **kwargs):
        ...
        total_late_minutes = attendance.aggregate(
            total=Sum('late_minutes')
        )['total'] or 0

        total_undertime_minutes = attendance.aggregate(
        ...
        self.absent_deduction = self.money(
            absent_deduction
        )
        ...
        # Round final payroll to the nearest whole peso.
        # Example:
        # 3286.49 becomes 3286.00
        # 3286.50 becomes 3287.00
        # 3286.99 becomes 3287.00
        self.total_salary = self.whole_number(
            total_salary
        )
